...
public class SuperCheckBox extends View implements Checkable {
    ...
    public SuperCheckBox(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.SuperCheckBox);
        int tickColor = ta.getColor(R.styleable.SuperCheckBox_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.SuperCheckBox_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.SuperCheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.SuperCheckBox_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.SuperCheckBox_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SuperCheckBox_stroke_width, Utils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SuperCheckBox checkBox, boolean isChecked);
    }
}